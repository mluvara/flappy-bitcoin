...
ctx.fillText('High Score: ' + highScore, canvas.width * 0.02, canvas.height * 0.1);
...
if (gameState === 'gameover') {
  ...
  ctx.fillText('Game Over', canvas.width / 2, canvas.height / 2 - canvas.height * 0.1);

  ctx.font = `${canvas.width * 0.03}px Arial`;
  ctx.fillText('Your Score: ' + score, canvas.width / 2, canvas.height / 2 - canvas.height * 0.02);

  // Display the high score
  ctx.fillText('High Score: ' + highScore, canvas.width / 2, canvas.height / 2 + canvas.height * 0.04);

  ctx.fillText('Press Space or Click to Restart', canvas.width / 2, canvas.height / 2 + canvas.height * 0.1);
